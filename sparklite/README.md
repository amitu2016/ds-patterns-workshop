# sparklite — a distributed compute engine

Models **Apache Spark**. Class names, package layout and class responsibilities mirror upstream, so the real
...
A **structural** model, not a reimplementation. Where we diverge from Apache Spark deliberately — collapsed
